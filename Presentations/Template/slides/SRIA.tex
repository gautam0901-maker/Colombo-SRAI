...
{ \framesubtitle{Gautam}
    ...
    An example project develops an \textbf{affordable maritime security system} that allows \textbf{small patrol boats to work together} with \textbf{long-endurance drones} and \textbf{underwater robots}. By combining all their \textbf{sensors and information into one platform}, small vessels can perform missions that normally require large and costly naval ships. The system gathers data from satellites, land and sea sensors, and unmanned vehicles, merges it into one clear operational picture, and \textbf{supports better decision-making} in command centres. It will be tested in large, realistic demonstrations across multiple scenarios. The timeframe of this project is set to \textbf{18 month} within a budget of \textbf{5 Million €}.
