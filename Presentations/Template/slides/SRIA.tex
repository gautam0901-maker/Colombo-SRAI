...
{ \framesubtitle{Gautam and Malena}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            \begin{itemize}
                \item Innovation \& Research
                \item Green Transition \& Climate Funding
                \item Digital Transformation
                \item Infrastructure \& Supply Chains
                \item Regional Development \& Social Funds
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{itemize}
                \item Excellence (new and innovative)
                \item Impact to society
                \item Implementation realistic
            \end{itemize}
        \end{column}
...
{\framesubtitle{Malena}
	\begin{itemize}
		...
		\item Forms the basis for annual or multi-annual work programmes \cite{ERALearn:2025}
	\end{itemize}
}
...
{\framesubtitle{Malena}
        \begin{itemize}
            \item \textbf{Strategic \& impact-driven:} Clear vision, objectives, and measurable targets
            \item \textbf{Openness \& transparency:} Inclusive and transparent development process
            \item \textbf{Flexibility:} Adaptable structure with periodic review and refinement
            \item \textbf{Commitment \& ownership:} Active involvement of all key stakeholders
            \item \textbf{Synergies:} Alignment with EU, national, and regional initiatives \cite{ERALearn:2025}
        \end{itemize}
...
%{\framesubtitle{Malena}
%	\begin{itemize}
%        \item \textbf{Vision \& Mission:} defines the long-term ambition and the core purpose of the partnership
%        \item \textbf{Intervention Logic \& Impact Pathways:} maps how objectives lead to outcomes, impacts and results, and tracks progress
%        \item \textbf{Prioritized Lines of Action:} a detailed action plan that enables annual or multi-annual work plans
%        \item \textbf{Objectives \& Targets:} clear, measurable goals to assess progress and success
%        \item \textbf{Engagement of Stakeholders \& Adaptability:} includes involvement of relevant actors and allows adaptability to changing needs or context \cite{ERALearn:2025}
%    \end{itemize}
%}
